...
global.youtube = 'https://youtube.com/@RGrowds AD'
global.ig = 'https://instagram.com/agatdwi_subakti'
global.mygc = 'https://chat.whatsapp.com/'
global.myweb = 'https://trakterr.id/AgatZ'
...
global.email = 'agatdwisubaktiyan444@gmail.com'
...
//—————「 Set Nama Own & Bot 」—————//
global.nomerOwner = "623121562064" //Bebas ganti 
global.namaOwner = "AgatZ" //Bebas ganti
global.footer = 'AgatZ' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
global.packname = '20-05-2022 (AgatZ'
global.ownerr = ['Agat']
global.author = '[Agat]'
global.prefa = ['','!','.',',','#','*']
global.sp = '⭔'
...
global.removebgkey = "z1eFTRHcPRjPC6KgeTJDcdbR" //Login di https://www.remove.bg
//=================================================//
